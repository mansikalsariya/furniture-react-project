...
const Cart = () => {
  ...
  const navigate = useNavigate(); // For navigating to the checkout page
                      ...
                      <tr key={key} className="hover:bg-gray-100 transition-all">
                        ...
                        <td className="text-center px-4 py-2">
                          <div className="flex mr-3">
                            <button
                              className="border mt-4 py-3 px-6 hover:bg-gray-200"
                              onClick={() =>
              ...
              <div className="p-6 w-2/5 rounded-2xl shadow-2xl bg-white font-bold mt-4">
                ...
                <div className="whitespace-nowrap flex items-center justify-between mt-4">
                  <div
                    ...
                    onClick={handleCheckout} // Trigger checkout redirection
                  >
                    Proceed To Checkout
                  </div>
